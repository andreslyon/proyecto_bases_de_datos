...
if(isset($_POST["search"]))
{
  ...
  $query = $query." NATURAL JOIN pyr INNER JOIN recursosaprobados ON pyr.rid=recursosaprobados.rid";
...
<div class= "h1">
  <center><h2 class="room-name">Proyectos Clandestinos</h2></center>
</div>
...
<center>
  ...
  <div class="container">
    <!-- <div class="row col-md-10 col-md-offset-2 custyle"> -->
      ...
      <form align="center" action="clandestinos.php" method="post">
        <div class="row">
        ...
        <div class="table-wrapper-scroll-y my-custom-scrollbar">
          <table class="table table-bordered table-striped mb-0">
            ...
            <tr>
              ...
              <th class="text-center">Recursos aprobado desde</th>
            </tr>
            </thead>
