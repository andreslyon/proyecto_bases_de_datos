    ...
    <div class="container">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-0 shadow" onclick="window.location.href= 'views/pages/busqueda_index.php'; ">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPH4hkKgW2WEXtf2keyN7tzeSqdIggGNxXK_JWxsC39MZX9OTL" class="card-img-top" alt="...">
              <div class="card-body text-center">
                <h5 class="card-title mb-0">Busqueda por nombre</h5>
                <div class="card-text text-black-50">¿Buscas una entidad en particular?</div>
              </div>
            </div>
          </div>
