...
<body>
  <form class="login-wrap" action="_login_access_redirect.php" method="POST">
      ...
      <div class="login-form">
        ...
        {
          $_SESSION["login_bad_access"] = False;
          echo"
          	<div class='sign-in-htm'>
              <div class='group'>
      					<label  for='user' class='label'>Nombre</label>
      					<input name='socio_nombre' id='user' type='text' class='input' style='background:rgba(255,100,100,.4);'>
      				</div>
      				<div class='group'>
      					<label for='pass' class='label'>Apellido</label>
      					<input name='socio_apellido' id='pass' type='text' class='input' style='background:rgba(255,100,100,.4);'>
      				</div>
      				<div class='group'>
      					<label for='pass' class='label'>Password</label>
                <input name='socio_password' id='pass' type='password' class='input' data-type='password' style='background:rgba(255,100,100,.4);'>
              </div>
              <div class='group'>
                <input id='check' type='checkbox' class='check' checked>
                <label for='check'><span class='icon'></span> Recordarme</label>
              ...
              <br><div style='color:rgb(255,100,100)' class='invalid-feedback'>Error al ingresar, revisa tus datos.</div>
            </div>

            <div class='sign-up-htm'>
              <div class='group'>
                <label  for='user' class='label'>Nombre de la ONG</label>
                <input name='ong_nombre' id='user' type='text' class='input' style='background:rgba(255,100,100,.4);'>
              </div>
              <div class='group'>
                <label for='pass' class='label'>Password</label>
                <input name='ong_password' id='pass' type='password' class='input' data-type='password' style='background:rgba(255,100,100,.4);'>
              </div>
              <div class='group'>
                <input id='check' type='checkbox' class='check' checked>
                <label for='check'><span class='icon'></span> Recordarme</label>
