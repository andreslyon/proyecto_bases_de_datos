...
<form class="login-wrap" action="_agregar_proyecto.php" method="POST">
  <div class="login-html">
    <label  for='user' class='label' style="font-size:25px;color:rgb(255,255,255)">Planificacion Automatica</label>
    <hr>
    <br><br>
    ...
    <div class="login-form">
      <div class='sign-in-htm'>
        <div class='group'>
          <label  for='user' class='label'>Elige una comuna:</label>
        ...
        <div class='group'>
          <label  for='user' class='label'>Presupuesto total:</label>
          <input name='presupuesto' id='user' type='number' class='input'>
        </div>
        <div class='group'>
          <button name='crear_proyecto' type='submit' class='button' value='True'>Planificar</button>
        </div>
      </div>
