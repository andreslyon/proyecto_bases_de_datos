...
if(isset($_POST["search"]))
{
  ...
  $query = "SELECT * FROM proyectos NATURAL JOIN proyectosvertederos";
  $query = $query." NATURAL JOIN pyl NATURAL JOIN lugares";
  $search_result = filterTable($query) -> fetchALL();
}
...
<div class= "h1">
  <center><h2 class="room-name">Vertederos</h2></center>
</div>
...
<center>
  ...
  <div class="container">
    <!-- <div class="row col-md-10 col-md-offset-2 custyle"> -->
      ...
      <form align="center" action="vertederos.php" method="post">
        <div class="row">
